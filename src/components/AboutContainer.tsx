...
const AboutContainer: React.FC = () => {
  return (
    <section id="about-container">
      ...
      <p>A minha missão é criar soluções inovadoras, eficientes e escaláveis, que atendam às demandas do mercado e dos usuários. </p>
      <p>Sou apaixonado por tecnologia, aprendizado contínuo e colaboração. Busco sempre me atualizar sobre as novidades e tendências do setor, e compartilhar o meu conhecimento e experiência com a minha equipe e a comunidade. O meu objetivo é crescer profissionalmente, desenvolver novas habilidades e buscar desafios, fazendo parte de projetos que tragam impacto positivo à sociedade.</p>
